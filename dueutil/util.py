...
def random_embed_color_hex():
    r = lambda: random.randint(0,255)
    return ('%02X%02X%02X' % (r(),r(),r()))


def random_embed_color_decimal():
    i = random_embed_color_hex()
    return int(i, 16)

def translate_input(message, language):
    translation = translator.translate(message, dest=language)
    message = translation.text
    stats2.increment_stat(stats2.Stat.TRANSLATIONS_DONE)
    return message

def translate(message, language):
    translation = translator.translate(message, dest=language, src='en')
    message = translation.text
    stats2.increment_stat(stats2.Stat.TRANSLATIONS_DONE)
    return message

def translate_2(message1, message2, language):
    translations = translator.translate([message1, message2], dest=language, src='en')
    n = 0
    for translation in translations:
        translations[n] = translation.text
        n = n + 1
    translation_list = list(translations)
    stats2.increment_stat(stats2.Stat.TRANSLATIONS_DONE)
    return translation_list

def translate_3(message1, message2, message3, language):
    translations = translator.translate([message1, message2, message3], dest=language, src='en')
    n = 0
    for translation in translations:
        translations[n] = translation.text
        n = n + 1
...
def translate_4(message1, message2, message3, message4, language):
    translations = translator.translate([message1, message2, message3, message4], dest=language, src='en')
    n = 0
    for translation in translations:
        translations[n] = translation.text
        n = n + 1
...
def translate_5(message1, message2, message3, message4, message5, language):
#    s = "-"
#    list1 = s.join(list1)
    translations = translator.translate([message1, message2, message3, message4, message5], dest=language, src='en')
    n = 0
...
def translate_5_2(message, language):
    translations = translator.translate(message, dest=language, src='en')
    translation_list = translations.text
    translation_list = re.split('-', translation_list)
    return translation_list

def translate_6(message1, message2, message3, message4, message5, message6, language):
    translations = translator.translate([message1, message2, message3, message4, message5, message6], dest=language, src='en')
    n = 0
    for translation in translations:
        translations[n] = translation.text
        n = n + 1
...
def translate_7(message1, message2, message3, message4, message5, message6, message7, language):
    translations = translator.translate([message1, message2, message3, message4, message5, message6, message7], dest=language, src='en')
    n = 0
    for translation in translations:
        translations[n] = translation.text
        n = n + 1
...
def translate_8(message1, message2, message3, message4, message5, message6, message7, message8, language):
    translations = translator.translate([message1, message2, message3, message4, message5, message6, message7, message8], dest=language, src='en')
    n = 0
    for translation in translations:
        translations[n] = translation.text
        n = n + 1
...
def translate_9(message1, message2, message3, message4, message5, message6, message7, message8, message9, language):
    translations = translator.translate([message1, message2, message3, message4, message5, message6, message7, message8, message9], dest=language, src='en')
    n = 0
    for translation in translations:
        translations[n] = translation.text
        n = n + 1
...
def translate_10(message1, message2, message3, message4, message5, message6, message7, message8, message9, message10, language):
    translations = translator.translate([message1, message2, message3, message4, message5, message6, message7, message8, message9, message10], dest=language, src='en')
    n = 0
    for translation in translations:
        translations[n] = translation.text
        n = n + 1
...
def translate_11(message1, message2, message3, message4, message5, message6, message7, message8, message9, message10, message11, language):
    translations = translator.translate([message1, message2, message3, message4, message5, message6, message7, message8, message9, message10, message11], dest=language, src='en')
    n = 0
    for translation in translations:
        translations[n] = translation.text
        n = n + 1
...
def translate_12(message1, message2, message3, message4, message5, message6, message7, message8, message9, message10, message11, message12, language):
    translations = translator.translate([message1, message2, message3, message4, message5, message6, message7, message8, message9, message10, message11, message12], dest=language, src='en')
    n = 0
    for translation in translations:
        translations[n] = translation.text
        n = n + 1
