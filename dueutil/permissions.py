...
class Permission(Enum):
    ...
    DUEUTIL_AMBASSADOR = (lambda member: has_special_permission(member, permissions[5]), "community_ambassador",)
    DUEUTIL_MOD = (lambda member: has_special_permission(member, permissions[6]), "junior_staff",)
    DUEUTIL_ADMIN = (lambda member: has_special_permission(member, permissions[7]), "staff",)
    DUEUTIL_OWNER = (lambda member: has_special_permission(member, permissions[8]), "dueutil_owner",)
